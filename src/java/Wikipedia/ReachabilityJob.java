...
import Pokec.ExampleBaseJob;
import Pokec.Node;
import Pokec.SearchMapper;
import Pokec.SearchReducer;
 ...
 */
public class ReachabilityJob extends Wikipedia.ExampleBaseJob {
...
// output keys type, the output values type
    public static class ReachabilityMapper extends Wikipedia.SearchMapper {
        ...
        public void map(Object key, Text value, Context context)
            ...
            Wikipedia.Node inNode = new Wikipedia.Node(value.toString());
            ...
            if(inNode.getId().equals(src)){
                ...
                inNode.setColor(Wikipedia.Node.Color.GRAY);
     ...
     *         Hadoop version used : 0.20.2
     */
    public static class ReachabilityReducer extends Wikipedia.SearchReducer {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context)
            ...
            Wikipedia.Node outNode = new Wikipedia.Node();
            ...
            if(outNode.getColor() != Wikipedia.Node.Color.WHITE && key.toString().equals(dest)){
            ...
            if (outNode.getColor() == Wikipedia.Node.Color.GRAY){
